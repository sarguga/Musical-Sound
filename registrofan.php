<html>
	...
	if(isset($_POST['enviar'])){
		...
		('$user', '$pass', '$nombre', '$email', '$telefono', 3, '$ciudad')";
		if(mysqli_query($con,$insert)){
			$id=mysqli_insert_id($con);
			$sql="insert into Fan(id_fan, apellido, fecha_nac, sexo) values ('$id', '$apellido', '$fecha_nac', '$sexo')";
	...
	echo "<div id='form'><form method='post' action='".$_SERVER['PHP_SELF']."'>
			...
			<input type='radio' name='sexo' value='M'>Mujer</input><br/>
